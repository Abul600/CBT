    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                <h1 class="text-2xl font-bold mb-4">Welcome, Paper Seater!</h1>
                <h3 class="text-lg font-bold mb-4">Paper Seater Panel</h3>
                <p class="mb-4">Manage exam questions and papers efficiently.</p>
